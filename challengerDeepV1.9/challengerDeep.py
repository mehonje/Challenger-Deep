...
class gameEngine:
    def __init__(self, gameName):
        ...
        print("This project was made using Mehonje's Game Engine - https://github.com/mehonje/Mehonje-s-Game-Engine")
        print("(Ͻ) This project is open-source")
        ...
        self.playerY = -2000
        self.camY = self.playerY
        self.playerDepth = self.camY * 0.1
        self.ballastEnabled = 1
        self.ship = randint(1, 2)
        self.menu = 1
